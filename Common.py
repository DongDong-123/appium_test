...
class Common(object):
    ...
    # 立即申请
    def apply_now(self):
        self.driver.find_element_by_xpath(".//a[@class='buy ']").click()
    ...
    def commit_order(self):
        print("开始提交订单")
        locator = (By.XPATH, "(.//div[@class='realPay-wrapper']/span[3])")
        WebDriverWait(self.driver, 30, 1).until(EC.element_to_be_clickable(locator))
        case_name = self.driver.find_element_by_xpath(".//div[@class='title']").text
        case_number = self.driver.find_element_by_xpath(".//div[@class='number']").text
        case_price = self.driver.find_element_by_xpath(".//div[@class='money']/span[2]").text
        totalprice = self.driver.find_element_by_xpath(".//span[@class='money lbneedpay']").text
    ...
    def pay(self):
        print("开始支付")
        pay_totalprice = self.driver.find_element_by_xpath(".//b[@class='bottom-pay-price-top']").text
        self.driver.find_element_by_xpath(".//a[@class='bottom-pay']").click()
    ...
    def qr_shotscreen(self, name):
        ...
        # 点击继续支付
        # //a[@class='J-startapp am-button am-button-blue']
